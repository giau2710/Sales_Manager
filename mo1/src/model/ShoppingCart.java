...
public class ShoppingCart implements IByProduct {
    ...
    public ShoppingCart(String username, String productId, String productName, int quantity, int sumPrice, String dateBy) throws ParseException {
    ...
    public String toString() {
        return getCustomer().getUsername() + ";" + productId + ";" + productName + ";" + quantity + ";" + sumPrice + ";" + dateBy;
    }
}
